...
#define STRING_CONFIG_H_AUTHOR "M. Nehring - Endeavor Lab" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Endeavor_Monster_12-2021"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki 3.096
    #define DEFAULT_Kd 129
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 204.9
  #define DEFAULT_bedKi 9.655
  #define DEFAULT_bedKd 1087
...
#define DELTA
  ...
  #define DELTA_RADIUS 157.0741             // (mm) Get this value from G33 auto calibrate
...
#define XYZ_MICROSTEPS 32   //this is set by jumper J3 on the motherboard
#define XYZ_BELT_PITCH 2
//TEVO was *supposed* to have 20 teeth gears. But it came short parts and I put in 16 teeth gears
#define XYZ_PULLEY_TEETH 16
// steps per unit is therefore (XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / (double(XYZ_BELT_PITCH) * double(XYZ_PULLEY_TEETH))
//which equals 266.67
//the extruder 785 came from the little monster config file, so hoping its right
//i'm having issues w/ stepper accuracy, so i'm just going to hard code the value directly
//#define DEFAULT_AXIS_STEPS_PER_UNIT {200,200,200,785}

#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / (double(XYZ_BELT_PITCH) * double(XYZ_PULLEY_TEETH)))
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 785 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 600, 50 }
...
//#define HOMING_FEEDRATE_Z  (200*60) // Delta only homes to Z
