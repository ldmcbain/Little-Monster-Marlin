...
/**
Added this (and code in temperature.cpp) because
my delta has heating issues on the MB when the heatbed is on
HOWEVER.. there is a MB cooling fan attached to the E0..
So I'll just create this to turn on E0 fan (and MB fan)
whenever the Heated Bed is on
Note, this is based upon TARGET bed temp, not actual temp
as the issue is w/ the fets on the MB being on.
*/
#define E0_AUTO_FAN_BED_ON true
#define EXTRUDER_AUTO_BED_TEMPERATURE 50
 ...
 */
//#define PWM_MOTOR_CURRENT { 1500, 1500, 1500 }          // Values in milliamps
...
#define G29_RETRY_AND_RECOVER
   ...
   */
  //upon successful leveling, do the following:
  //enter absolute mode
  //Goto X0Y0Z13
  //Set current Z to 10 (removes std offset)
  //enter relative mode
  //After a successfull G29 call, the Gcode will need to:
    //increase Z by offset (1.18etc)
    //enter absolute mode
    //set z to 10
